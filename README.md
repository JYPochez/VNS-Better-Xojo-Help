...
- **Tabs.** Cmd-click a link or a topic to open one behind what you are reading.
...
Signed and notarised builds live in [`Binaries/`](Binaries). For Apple Silicon:
`Better-Xojo-Help-0.15.0-macOS-arm64.zip` — unzip and drag to Applications, and it will open without
